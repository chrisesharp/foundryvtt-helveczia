...
export async function preloadTemplates(): Promise<Handlebars.TemplateDelegate[]> {
  const templatePaths: string[] = [
    ...
    // Item Sheets
    'systems/helveczia/templates/item/partials/armour-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/book-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/book-sheet-spells.hbs',
    'systems/helveczia/templates/item/partials/class-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/deed-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/people-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/possession-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/skill-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/spell-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/weapon-sheet-header.hbs',
    'systems/helveczia/templates/item/partials/weapon-sheet-damage.hbs',
    // Item Partials
